...
for T in T_list
    ...
    if N_chain >= 92
        ...
        a2_100 = ab2[92, 1]
        b2_100 = ab2[92, 2]
        [ab1[i, 1] = a1_100 for i = 93:N_coeff]
        [ab1[i, 2] = b1_100 for i = 93:N_coeff]
        [ab2[i, 1] = a2_100 for i = 93:N_coeff]
        [ab2[i, 2] = b2_100 for i = 93:N_coeff]
    else
    ...
    mean_Q = real(imag(last(char_fn_1)) / u)
    var_Q = real(-(log(last(char_fn_2)) + log(last(char_fn_1))) / (u^2))
